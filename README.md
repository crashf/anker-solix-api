...
This is an experimental Python library for Anker Solix Power devices (Solarbank, Inverter, Smart Meter, Portable Power Station etc).
...
`pps` | Anker Solix Portable Power Stations (PPS) with Smart Meter support:<br>- A1782: SOLIX F3000 Portable Power Station (3072Wh, MQTT supported)
...
**MQTT Support Status:**
- ✅ **F3000 Portable Power Station (A1782)**: Full MQTT protocol decoded with 5 message types (0857, 0401, 0421, 0889, 0301) supporting real-time AC/USB power monitoring, battery status, and device control
- 🔄 Other device models: Work in progress, contributions welcome
